      ...
      <div className="text-center">
        ...
        <div className="flex items-center justify-center w-full">
          <div className="flex flex-col items-center justify-center w-full max-w-xs px-4  bg-white rounded-lg">
            <h1 className="text-2xl font-semibold text-gray-950 mb-5">
              Sign Up
            </h1>
            <p className="text-sm text-gray-500 mb-5">Enter your details below to play this classic</p>
            <ToastContainer />
            <form
          ...
          <div className="relative">
            ...
            <button onClick={() => navigate("/auth/login")} className="text-sm text-blue-600 hover:underline px-1">
              Login
            </button>
          </div>
          </div>
